...
const sendResults = function(response){
  ...
  debugger
  const fieldValue = {};
  fieldValue.backgroundType='image';
  fieldValue.backgroundImage=response;
  fieldValue.backgroundDisplay=backgroundDisplayType.value;
  emit('cevt', [c.FIELD_CHANGED,props.config.parentName, fieldValue]);
/*
...
//    this.emit('cevt', [c.FIELD_CHANGED,'backgroundType', 'image', response.data]);
//    this.emit('cevt', [c.FIELD_CHANGED,'backgroundImage', response.data]);
//    this.emit('cevt', [c.FIELD_CHANGED,'backgroundDisplay', backgroundDisplayType.value]);
